...
Revision ID: 71557a7270ad
Revises: 
Create Date: 2021-02-27 14:47:22.826055
...
def upgrade():
    ...
    sa.ForeignKeyConstraint(['book_id'], ['book.name'], ),
    sa.ForeignKeyConstraint(['user_id'], ['user.useremail'], ),
    sa.PrimaryKeyConstraint('id')
    )
